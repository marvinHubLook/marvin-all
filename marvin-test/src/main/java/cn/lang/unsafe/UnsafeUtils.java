...
import cn.lang.reflect.ReflectionUtils;
...
import static cn.lang.reflect.ReflectionUtils.assertArrayIndex;
import static cn.lang.reflect.ReflectionUtils.assertFieldMatchType;
...
public abstract class UnsafeUtils {
     ...
     */
    public static long arrayIndexOffset(int index, long baseOffset, long indexScale) {
        if (index < 0)
